...
namespace WebAPI.Migrations
{
    ...
    [Migration("20230128001913_RenameColumnBeoordelingen")]
    partial class RenameColumnBeoordelingen
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GebruikerKlas", b =>
                {
                    ...
                    b.HasKey("GebruikersId", "KlassenId");

                    b.HasIndex("KlassenId");

                    b.ToTable("Klas_Gebruiker", (string)null);
                });
            ...
            modelBuilder.Entity("WebAPI.Entities.Beoordeling", b =>
                {
                    ...
                    b.Property<int?>("TentamenVanStudentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TentamenVanStudentId")
                        .IsUnique()
                        .HasFilter("[TentamenVanStudentId] IS NOT NULL");
            ...
            modelBuilder.Entity("WebAPI.Entities.Beoordeling", b =>
                {
                    ...
                    b.HasOne("WebAPI.Entities.TentamenVanStudent", "TentamenVanStudent")
                        .WithOne("Beoordeling")
                        .HasForeignKey("WebAPI.Entities.Beoordeling", "TentamenVanStudentId");

                    b.Navigation("Beoordelingsmodel");

                    b.Navigation("Docent");

                    b.Navigation("TentamenVanStudent");
                });
            ...
            modelBuilder.Entity("WebAPI.Entities.Gebruiker", b =>
                {
                    ...
                    b.Navigation("Toetsinschrijvingen");
                });
